...
class ISISInstance(BaseModel):
    ...
    local_interfaces: list[ISISInterface] | None = None
    """Interfaces participating in the IS-IS. Required field in the `VerifyISISNeighborCount` test."""
...
class ISISInterface(BaseModel):
    ...
    def __str__(self) -> str:
        ...
        return f"Interface: {self.name} Level: {self.level}"
