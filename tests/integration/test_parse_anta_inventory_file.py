...
def test_parse_anta_inventory_file(capsys: pytest.CaptureFixture[str], inventory: AntaInventoryHost) -> None:
    ...
    yaml_data = {AntaInventoryHost.INVENTORY_ROOT_KEY: inventory.dump().model_dump()}
